...
public class CompareController
{
	...
	/**
	 * This function updates the TreeViews with the selected years when the
	 * 'Compare' button is pressed. The outer TreeViews are populated with the
	 * PlanFile's section names while the inner TreeViews are populated with the
	 * PlanFile's section contents.
	 * 
	 * @param event
	...
	/**
	 * This function compares 2 TreeViews and graphically updates TreeItems that
	 * contain conflicts
	 * 
	 ...
	 * @param showData a boolean regarding whether the TreeItem should display the
	 *                 plan section's content
	...
	/**
	 * This function uses recursive search through the root node to create a
	 * TreeView
	 * 
	...
	/**
	 * This function allows the 'Return' button to switch the stage to the MainScene
	 * view
	 * 
	 * @param event
	 * @throws IOException
